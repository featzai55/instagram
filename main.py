...
TOKEN = "1730140495:AAEFBlcod4GIFskKi3apzQ-I6qEm0SOq064"
...
def download(bot, update):
    ...
    if instagram_post=="/start":
        ...
        update.message.reply_text("Hello sir ☺️   \n Format of using this bot:- https://www.instagram.com/p/B4zvXCIlNTw/ \nVideos Must Be Less Then 20MB, For Now It Cannot Support Long IGTV Videos \n\n<b>Report Bugs :-</b> @ftfridaybot \n<b>🌀 Owner</b> \nhttps://t.me/featzai", parse_mode=ParseMode.HTML, disable_web_page_preview=True)
    else:
        pass
    if "instagram.com" in instagram_post:
        ...
        try:
            ...
            bot.sendMessage(chat_id=update.message.chat_id, text="Only Supports Public ig posts 🍻")
